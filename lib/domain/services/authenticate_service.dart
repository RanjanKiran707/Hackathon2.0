class ApiConstants {
  ...
  static String getDetails = "details/getInfo";
  static String getFood = "inventory/getlist";
  static String addOrder = "order/addorder";
  static String addQ = "forum/addquestion";
